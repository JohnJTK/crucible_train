defmodule CrucibleTrain.Completers.TinkexMessageCompleter do
  @moduledoc """
  Message completer backed by a renderer and a Tinkex-style sampling client.
  """
  ...
  @impl true
  def complete(%__MODULE__{} = completer, messages) when is_list(messages) do
    stop_condition =
  ...
  defp parse_response(response, renderer_module, renderer_state) do
    ...
    case sequences do
      [sequence | _] ->
        ...
        {parsed, _format_ok} = renderer_module.parse_response(tokens, renderer_state)
