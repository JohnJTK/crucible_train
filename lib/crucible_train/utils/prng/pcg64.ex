defmodule CrucibleTrain.Utils.PRNG.PCG64 do
  @moduledoc """
  ...
  alias CrucibleTrain.Utils.PRNG.SeedSequence
  ...
  def seed(seed_value) when is_integer(seed_value) and seed_value >= 0 do
    ...
    {state_high, state_low, inc_high, inc_low} = SeedSequence.generate_pcg64_state(seed_value)
