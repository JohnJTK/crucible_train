defmodule CrucibleTrain.Types.Datum do
  @moduledoc """
  A training datum containing model input and loss function inputs.

  A Datum is the fundamental unit passed to the training API, containing:
  - `model_input`: The input to the model (sequence of chunks)
  - `loss_fn_inputs`: A map containing loss inputs such as weights and target tokens
  """
  ...
  @doc """
  Creates a new Datum with model_input and loss_fn_inputs.
  """
  ...
  @doc """
  Returns the weights TensorData from loss_fn_inputs.
  """
  ...
  @doc """
  Returns the target_tokens TensorData from loss_fn_inputs.
  """
  ...
  @doc """
  Returns the sum of weights (number of loss tokens).
  """
