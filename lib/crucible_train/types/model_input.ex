defmodule CrucibleTrain.Types.EncodedTextChunk do
  @moduledoc """
  ...
  @doc """
  Creates a new EncodedTextChunk with the given tokens.
  """
...
defmodule CrucibleTrain.Types.ImageChunk do
  @moduledoc """
  ...
  @doc """
  Returns the expected number of tokens for this image.
  """
  @spec length(t()) :: non_neg_integer()
  def length(%__MODULE__{expected_tokens: expected_tokens}), do: expected_tokens
end

defmodule CrucibleTrain.Types.ModelInput do
  @moduledoc """
  ...
  @doc """
  Creates a new ModelInput with the given chunks.
  """
  @spec new([chunk()]) :: t()
  ...
  @doc """
  Creates a ModelInput from a list of token integers.
  """
  ...
  @doc """
  Returns the total length across all chunks.
  """
  @spec length(t()) :: non_neg_integer()
