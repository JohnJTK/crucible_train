defmodule CrucibleTrain.RL.ProblemEnv do
  @moduledoc """
  ...
  alias CrucibleTrain.Utils.Logtree
  ...
  defmacro __using__(_opts) do
    quote do
      alias CrucibleTrain.RL.{Env, ProblemEnv}
...
defmodule CrucibleTrain.RL.ProblemGroupBuilder do
  @moduledoc """
