defmodule CrucibleTrain.Renderers.Implementations.DeepSeekV3 do
  @moduledoc """
...
defmodule CrucibleTrain.Renderers.Implementations.DeepSeekV3DisableThinking do
  @moduledoc """
  ...
  alias CrucibleTrain.Renderers.{Implementations.DeepSeekV3, Renderer}
