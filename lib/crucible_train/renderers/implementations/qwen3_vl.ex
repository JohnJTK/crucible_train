defmodule CrucibleTrain.Renderers.Implementations.Qwen3VL do
  @moduledoc """
  ...
  alias CrucibleTrain.Renderers.{Helpers, ToolCalls, Types, Vision}
  alias CrucibleTrain.Renderers.Implementations.Qwen3, as: Qwen3Impl
  ...
  def render_message(idx, message, _is_last, %{tokenizer: tokenizer} = state) do
    ...
    role = Qwen3Impl.qwen_role(message)
  ...
  @impl true
  def parse_response(tokens, state),
    do: CrucibleTrain.Renderers.Qwen3.parse_response(tokens, state)
...
defmodule CrucibleTrain.Renderers.Implementations.Qwen3VLInstruct do
  @moduledoc """
  ...
  alias CrucibleTrain.Renderers.{Helpers, ToolCalls, Types}
  alias CrucibleTrain.Renderers.Implementations.{Qwen3, Qwen3VL}
  alias CrucibleTrain.Types.EncodedTextChunk
